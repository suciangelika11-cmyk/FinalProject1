    ...
    @else
        ...
        <section class="empty-hero">
            <div class="empty-hero-content">
                <div class="hero-eyebrow"
                    style="display:inline-flex;align-items:center;gap:10px;background:var(--gold-dim);border:1px solid var(--border-strong);border-radius:40px;padding:7px 20px;font-size:10px;font-weight:500;color:var(--gold-pale);letter-spacing:0.2em;text-transform:uppercase;margin-bottom:24px;">
                    <i class="fa-solid fa-church" style="font-size:10px;"></i>
                    Gereja Beriman Indonesia
                </div>
                <h1
                    style="font-family:'Libre Baskerville',serif;font-size:clamp(36px,6vw,60px);line-height:1.1;margin-bottom:16px;">

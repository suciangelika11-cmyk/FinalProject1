    ...
    <div class="container">
        <div class="about-inner">
            <div class="reveal">
                ...
                <p class="about-text">GBI Tambunan adalah gereja yang berkomitmen untuk membangun jemaat yang kuat dalam iman, aktif dalam pelayanan, dan penuh kasih dalam persekutuan. Kami percaya bahwa setiap orang memiliki panggilan mulia dari Tuhan.</p>
            ...
            <div class="about-visual reveal">
                <div class="about-box">
                    ...
                    <div style="margin-top:20px;font-size:12px;color:var(--gold);letter-spacing:0.1em;">— Yohanes 3:16</div>
                </div>
            </div>
        </div>
    </div>

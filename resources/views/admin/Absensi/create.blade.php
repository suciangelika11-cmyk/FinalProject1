    ...
    <div class="form-card">
        ...
        <form action="{{ route('absensi.store') }}" method="POST">
            ...
            <div class="form-row-2">
                <div class="fg">
                    <label>Sesi</label>
                    <input type="text" name="session" value="{{ old('session') }}" placeholder="Contoh: Sesi 1" required>
                </div>

                <div class="fg">
                    <label>Jumlah Jemaat</label>
                    <input type="number" name="jumlah" value="{{ old('jumlah') }}" min="0" placeholder="0" required>
                </div>
            </div>
            ...
            <div class="form-row-2">
                <div class="fg">
                    ...
                    <input type="text" name="pengkhotbah" value="{{ old('pengkhotbah') }}" placeholder="Nama pengkhotbah" required>
                </div>

                <div class="fg">
                    <label>Pelayan</label>
                    <input type="text" name="pelayan" value="{{ old('pelayan') }}" placeholder="Nama pelayan" required>
                </div>
            </div>

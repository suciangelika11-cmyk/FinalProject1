...
<div class="form-wrap">
    <div class="form-card">
        ...
        <form action="{{ route('absensi.update', $absensi) }}" method="POST">
            ...
            <div class="fg">
                <label>Tanggal</label>
                <input type="date" name="date" value="{{ old('date', $absensi->date) }}" min="{{ date('Y-m-d') }}" required>
            </div>
            ...
            <div class="form-row-2">
                <div class="fg">
                    ...
                    <input type="text" name="pengkhotbah" value="{{ old('pengkhotbah', $absensi->pengkhotbah) }}" required>
                </div>

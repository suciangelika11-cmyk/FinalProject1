            ...
            <div class="form-row-2">
                ...
                <div class="fg">
                    ...
                    <select name="category" required>
                        ...
                        <option value="mingguan" {{ old('category') == 'mingguan' ? 'selected' : '' }}>Jadwal Mingguan</option>
                        <option value="acara_khusus" {{ old('category') == 'acara_khusus' ? 'selected' : '' }}>Acara Khusus</option>
                    </select>
                </div>
            </div>

...
<div class="content-header">
  <div>
    ...
    <div class="breadcrumb-bar"><a href="{{ route('admin.dashboard') }}">Home</a> / <a href="{{ route('kegiatan.index') }}">Kegiatan</a> / <span>Tambah</span></div>
  </div>
</div>
...
<div class="content">
  <div class="card">
    ...
    <p>Isi data kegiatan pelayanan agar dapat dikelola oleh admin dan super admin.</p>

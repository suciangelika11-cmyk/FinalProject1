    ...
    <div class="form-card">
        ...
        <form action="{{ route('khotbah.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="fg">
                ...
                <input type="text" name="title" value="{{ old('title') }}" placeholder="Contoh: Iman dalam Cobaan" required>
            </div>
            ...
            <div class="fg">
                ...
                <textarea name="description" rows="3" placeholder="Masukkan ringkasan khotbah">{{ old('description') }}</textarea>
            </div>

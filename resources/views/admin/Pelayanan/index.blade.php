...
@push('styles')
  <style>
    ...
    .leader-card:hover {
      ...
      box-shadow: 0 18px 34px rgba(4, 21, 54, .1);
    }
    ...
    .leader-avatar {
      ...
      border-radius: 50%;
      margin: 0 auto 18px;
      background: linear-gradient(180deg, rgba(29, 168, 224, .12), rgba(29, 168, 224, .04));
      border: 4px solid rgba(29, 168, 224, .12);
      display: grid;
      place-items: center;
      overflow: hidden;
    }
    ...
    .tim-card .anggota-label {
      margin-bottom: 8px;
    }

    .tim-card .anggota-row {
      font-size: 13px;
    }
    ...
    .empty-box {
      background: rgba(29, 168, 224, .05);
      border-color: rgba(29, 168, 224, .16);
    }
    ...
    .galeri-img {
      ...
      height: 160px;
      object-fit: cover;
      background: linear-gradient(135deg, var(--cyan-lt), var(--border));
      display: flex;
      align-items: center;
      justify-content: center;
      font-size: 36px;

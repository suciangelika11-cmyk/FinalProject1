            ...
            <form action="{{ route('pengumuman.update', $pengumuman->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-grid">
                    <div class="form-group full">
                        ...
                        <input type="text" name="title" class="form-control-custom" value="{{ old('title', $pengumuman->title) }}" required>
                    </div>

                    <div class="form-group full">
                        <label>Isi Pengumuman</label>
                        <textarea name="content" class="form-textarea-custom" required>{{ old('content', $pengumuman->content) }}</textarea>
                    </div>

                    <div class="form-group">
                        <label>Tanggal Publish</label>
                        <input type="date" name="publish_date" class="form-control-custom" value="{{ old('publish_date', $pengumuman->publish_date) }}" min="{{ date('Y-m-d') }}" required>
                    </div>
                    ...
                    <div class="form-group full">
                        ...
                        @if($pengumuman->image)
                            <img src="{{ asset('storage/' . $pengumuman->image) }}" alt="Gambar pengumuman" class="preview-img">
                        @endif
                    </div>
                </div>
